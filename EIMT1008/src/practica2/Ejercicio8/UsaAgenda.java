...
public class UsaAgenda {
    public static void main(String[] args) throws ExcepcionFechaNoValida {
        ...
        System.out.println("La lista de tareas se va a volver a crear y se va a borrar lo anterior a hoy( "+Fecha.hoy()+" )\n ----------------------------------------------------------");
        crearListaTareas(agenda);
        System.out.println("Agenda antes :");
        System.out.println(agenda);
        agenda.borrar();
        System.out.println("Agenda después :");
        System.out.println(agenda);
    }

    public static void crearListaTareas(Agenda agenda) throws ExcepcionFechaNoValida {
